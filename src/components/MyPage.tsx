  ...
  return (
    <div>
      ...
      <div className={"information-component-container"}>
        {informationState === 0 && <UserInformation username={username} />}
        {informationState === 1 && <ParentsInformation username={username} />}
        {informationState === 2 && <ChangePassword username={username} />}
      </div>
    </div>
  );
};
