          ...
          {Object.values(data).map((log: any, index: number) => (
            <TimelineItem key={index}>
              <TimelineOppositeContent sx={{ m: "auto 0" }} variant="body2">
                <div>
                  <span
                    style={{ color: log.point < 0 ? "#ce2c2c" : "#04ad04" }}
                  >
                    {log.point > 0 ? "상점" : "벌점"} {Math.abs(log.point)}점
                  </span>
                </div>
                <div>
                  총{" "}
                  <span style={{ color: "#2951c7" }}>{log.accumulate}점 </span>
                </div>
              ...
              <TimelineSeparator>
                ...
                <TimelineDot
                  style={{
                    backgroundColor: log.point < 0 ? "#ce2c2c" : "#04ad04",
                  }}
                >
